...
function setup_unmain(id){
    var href = $(this).attr('href');
    var message = $(this).data('confirm');
    swal({
        title: "Are you sure setup Un-Main this data ?",
        text: message, 
        icon: "info",
        buttons: true,
        dangerMode: false,
    ...
    .then((willDelete) => {
      if (willDelete) {
        var url ="{{url('dashboard/'.$controller.'/setup_main')}}";
        $.ajax({
            url : url,
            type: "POST",
            data: {
...
function setup_main(id){
    var href = $(this).attr('href');
    var message = $(this).data('confirm');
    swal({
        title: "Are you sure setup Main this data ?",
        text: message, 
        icon: "info",
        buttons: true,
        dangerMode: false,
