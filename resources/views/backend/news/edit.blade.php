                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_content_lang_id">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" id="title_id" name="title[id]" value="{{ $descriptions['id']->title }}" required="" maxlength="255">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="description_id"  class="control-label col-lg-2">{{ __('main.description') }} <span class="required">*</span></label>

                                            <input type="hidden" name="description_id" value="{{ $descriptions['id']->description }}">
                                            <div class="col-lg-12">
                                                <div style="height: 100%;" id="description_id">{!! $descriptions['id']->description !!}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
