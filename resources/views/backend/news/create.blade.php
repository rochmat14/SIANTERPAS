                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_content_lang_id">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12">
                                                    <input type="text" class="form-control" id="title_id" name="title[id]" value="{{ old('title.id') }}" required="" maxlength="255" placeholder="Masukan Judul berita atau artikel disini ...">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="description_id"  class="control-label col-lg-12">Masukan Isi Berita atau Artikel Di sini <span class="required">*</span></label>
                            ...
                            <div class="tab-pane  " id="tab_content_data">
                                ...
                                <div class="form-group{{ $errors->has('published_on') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="date-picker form-control" id="published_on" name="published_on" value="{{ old('published_on') !== Null ? old('published_on') : date('d-m-Y H:i:s') }}" required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <p>
                                            <i>Upload Image Rekomendasi Ukuran 557 x 373 px</i>
                                        </p>
