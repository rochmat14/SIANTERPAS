...
function edited(id){
    ...
    $.ajax({
        ...
        success: function(result)
        {
            ...
            $('[name="nama_client"]').val(result.data.nama_client);
                        ...
                        <div class="modal-body">
                            <form id="form" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="nama_client" class="control-label">Nama Client:</label>
                                    <input type="text" class="form-control" id="nama_client" name="nama_client" placeholder="Nama Client">
                                </div>
                                <div class="form-group">
                                    <label for="logo" class="control-label">Logo Client:</label>
                                    <input type="file" class="form-control" id="logo" name="logo" placeholder="Logo Client">
                                </div>
                            </form>
                        </div>
