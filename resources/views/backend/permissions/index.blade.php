...
$(document).ready(function() {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return `
                        ...
                        @if (auth()->user()->can($controller.'-delete'))
                            ...
                            <a href='javascript:void(0)' class="badge bg-light mt-2" onclick=removed("${deleteUrl}") title="Delete">
    ...
    @if(auth()->user()->can($controller.'-create'))
        $("div.custom-toolbar").html('<button class="btn btn-success waves-effect waves-light" onclick="add()"><i class="glyphicon glyphicon-plus"></i>Create Permissions</button> <button class="btn waves-effect waves-light btn-default" onclick="reload_table()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>');
    @endif
...
function edited(id){
    ...
    $.ajax({
        ...
        success: function(result)
        {
            ...
            $('.modal-title').text('Permissions Edit'); 
        },
