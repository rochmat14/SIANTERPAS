...
<div class="page-header">
  ...
  <section id="billboard" class="bg-light">
    ...
    <div class="container text-center">
      <form action="{{ route('antrianInformasi.store') }}" method="POST">
        @csrf
        @foreach($nomorAntrian as $data)
        <div class="row">
          ...
          <div class="col-xl-8 col-md-8 col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                      <h1>NOMOR URUT LAYANAN INFORMASI</h1>
                      <h1>
                        {{$data->nomor_urut}}
                      </h1>
              ...
              <a onclick="lInformasi()" class="btn btn-primary btn-lg col-xl-12 col-md-12 col-lg-12 mb-4 fw-bold">
                <i class="fa-solid fa-volume"></i>PANGGIL
              </a>
  ...
  <script>
    function lInformasi(){
        ...
        if(audio == nomor_urut) {
          var audio = new Audio("/audio/layanan_informasi/"+<?php echo json_encode($data->nomor_urut); ?>+".mp3");
          audio.play();
        }else{
