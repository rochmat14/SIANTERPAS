...
@section('content')
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-xl-8 col-md-8 col-lg-8">
                    <form action="{{ route('antrianPengaduan.store') }}" method="POST">
                        @csrf
                        @foreach($nomorAntrian as $data)
                        <div class="card">
                            <div class="card-body">
                                <h1>NOMOR URUT LAYANAN PENGADUAN</h1>
                        ...
                        <a onclick="lPengaduan()" class="btn btn-primary btn-lg col-xl-12 col-md-12 col-lg-12 mb-4 fw-bold">PANGGIL</a>
                    </form>
                </div>
                <div class="col-xl-2 col-md-2 col-lg-2"></div>
            </div>
    ...
    <script>
        function lPengaduan(){
            ...
            if(audio == nomor_urut) {
                var audio = new Audio("/audio/layanan_pengaduan/"+<?php echo json_encode($data->nomor_urut); ?>+".mp3");
                audio.play();
            }else{
