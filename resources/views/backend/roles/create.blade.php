...
<div class="row">
  <div class="col-12">
            ...
            <div class="form-body">
                ...
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" required class="form-control{{ $errors->has('name') ? ' form-control-danger' : '' }}">
                        @if ($errors->has('name'))
    ...
    <div class="form-group{{ $errors->has('deskripsi') ? ' has-danger' : '' }}">
        ...
        <input type="text" id="deskripsi" name="deskripsi" value="{{ old('deskripsi') }}" required class="form-control{{ $errors->has('deskripsi') ? ' form-control-danger' : '' }}">
