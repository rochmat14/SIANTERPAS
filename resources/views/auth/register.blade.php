                ...
                <div class="col-md-8 mx-auto d-block">
					...
					<form class="form-horizontal" method="POST" action="{{ route('register') }}">
						...
						<div class="input-group mb-4">
							...
							<input type="text" class="form-control" name="name" placeholder="Masukan Nama Anda" value="{{ old('name') }}">
						</div>
						@error('name')
						...
						<div class="input-group mb-4">
							...
							<input type="text" class="form-control" name="email" placeholder="Masukan Email Anda" value="{{ old('email') }}">
						</div>
						@error('email')
						...
						<div class="input-group mb-4">
							<span class="input-group-addon"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><g fill="none"><path d="M0 0h24v24H0V0z"/><path d="M0 0h24v24H0V0z" opacity=".87"/></g><path d="M6 20h12V10H6v10zm6-7c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2z" opacity=".3"/><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6zm9 14H6V10h12v10zm-6-3c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"/></svg></span>
							<input type="password" class="form-control" name="password_confirmation" placeholder="Konfirmasi Password diatas">
						</div>
						...
						<div class="form-group">
							<label class="custom-control custom-checkbox">
								...
								<span class="custom-control-label">Setuju Dengan Ketentuan  <a href="{{ url('term_and_condition') }}" class="btn-link" target="_blank">terms and policy</a> INB Logistik</span>
							</label>
						</div>
						<div class="row">
							<div class="col-12">
								<button type="submit" class="btn btn-lg btn-primary btn-block px-4"><i class="fe fe-arrow-right"></i> Registers Members</button>
							</div>
						</div>
					</form>
						<div class="pt-4">
							<div class="font-weight-normal fs-16">Jika Anda Sudah Memiliki Akun <a class="btn-link font-weight-normal" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(),URL::to( 'login' )) }}">Login Disini !</a></div>
						</div>
				</div>
            </div>
        </div>
