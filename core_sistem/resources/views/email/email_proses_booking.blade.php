...
<head>
    <title>Informasi Pemesanan Booking Orders</title>
...
<body style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;">
    ...
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: 'Lato', Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        Informasi Booking Orders | <strong>  {{ $return_data['type_booking'] }} </strong>
    </div>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                            <h1 style="font-size: 20px; font-weight: 400; margin: 2;">
                                ...
                                Terimakasih Sudah Meng-orders terkait  {{ $return_data['type_booking'] }}, <br>
                                
                                Kode Booking Orders Anda Adalah <strong>{{ $return_data['booking_code'] }}</strong>

                                <br>
                                KODE tersebut bisa digunakan untuk meng-track Transaksi anda pada url berikut <br>

                                <p style="margin: 0;"><a href="{{ url('id/track') }}" target="_blank" style="color: #8bc0e5;">TRACK TRANSAKSI</a></p>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 20px 30px 40px 30px;">
                            ...
                            <p>
                                <i>
                                    Sifat Harga Sudah Bersifat fixed, Mohon Lakukan Pembayaran Untuk Memproses Transaksi Anda. 
                                </i>
                                <br>
                                <br>
                                <hr>

                                Pembayaran Bisa Dilakukan Di Rekening Berikut .<br>
