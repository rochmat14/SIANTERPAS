...
<head>
    <title>Informasi Closing Orders</title>
...
<body style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;">
    ...
    <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: 'Lato', Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        Informasi Closing Orders | <strong>  {{ $return_data['type_booking'] }} </strong>
    </div>
                            ...
                            <table width="100%" cellpadding="1" cellspacing="1" border="1">
                                <thead>
                                  <tr>
                                    ...
                                    <th class="tx-center">Time Progress</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ formatHariJadwal($value->progress_time) }} , {{ formatDateTime($value->progress_time) }}</td>
