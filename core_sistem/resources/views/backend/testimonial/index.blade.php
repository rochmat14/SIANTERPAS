...
function edited(id){
    ...
    $.ajax({
        ...
        success: function(result)
        {
            ...
            $('[name="text"]').val(result.data.text);
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="form" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="text" class="control-label">Testimonial :</label>
                                    <textarea class="form-control" name="text" id="text" placeholder="Testimonial"></textarea>
                                </div>
                                <div class="form-group">
