...
! function(t, e) {
	...
	var K = {
		...
		Wt = C("wks"),
		zt = function(t) {
			return Wt[t] || (Wt[t] = Tt && Rt[t] || (Tt ? Rt : F)("Symbol." + t))
		},
		Ct = zt("species"),
		Nt = function(t, e) {
			var r;
	...
	var ge = {
		...
		je = ke(Array, "Array", (function(t, e) {
			Le(this, {
				type: "Array Iterator",
				target: m(t),
				index: 0,
				...
				if (o) s = t;
					...
					if (void 0 !== (h = a) && (le.Array === h || nr[rr] === h)) {
						for (c = 0, l = st(t.length); l > c; c++)
							if ((u = i ? d(j(f = t[c])[0], f[1]) : d(t[c])) && u instanceof e) return u;
						return new e(!1)
					}
					s = a.call(t)
				}
	...
	var gi = function() {
		...
		return e.init = function() {
			...
			this.resizeObserver = new di((function() {
				1 !== ++e && t.recalculate()
			})), this.resizeObserver.observe(this.el), this.resizeObserver.observe(this.contentEl), this.mutationObserver = new MutationObserver(this.recalculate), this.mutationObserver.observe(this.contentEl, {
				childList: !0,
				subtree: !0,
				characterData: !0
			})
			...
			var n = this.axis[e].scrollbar.rect[this.axis[e].offsetAttr],
				...
				s = ("y" === e ? this.mouseY - n : this.mouseX - n) < 0 ? -1 : 1,
				a = -1 === s ? o - i : o + i;
			! function t() {
				var n, i; - 1 === s ? o > a && (o -= 40, r.contentWrapperEl.scrollTo(((n = {})[r.axis[e].offsetAttr] = o, n)), window.requestAnimationFrame(t)) : o < a && (o += 40, r.contentWrapperEl.scrollTo(((i = {})[r.axis[e].offsetAttr] = o, i)), window.requestAnimationFrame(t))
			}()
			...
			return "none" === getComputedStyle(this.contentWrapperEl, "::-webkit-scrollbar").display || "scrollbarWidth" in document.documentElement.style ? 0 : function() {
				if (null === pi) {
	...
	(Mi || ji) && (Li = function(t) {
		var e, r, n, i, o = this;
		return ji && (r = new RegExp("^" + o.source + "$(?!\\s)", Si.call(o))), Mi && (e = o.lastIndex), n = Ai.call(o, t), Mi && n && (o.lastIndex = o.global ? n.index + n[0].length : e), ji && n && n.length > 1 && ki.call(n[0], r, (function() {
	...
	return gi.initDOMLoadedElements = function() {
		document.removeEventListener("DOMContentLoaded", this.initDOMLoadedElements), window.removeEventListener("load", this.initDOMLoadedElements), Array.prototype.forEach.call(document.querySelectorAll('[data-simplebar]:not([data-simplebar="init"])'), (function(t) {
			gi.instances.has(t) || new gi(t, qi(t.attributes))
		}))
	}, gi.removeObserver = function() {
		this.globalObserver.disconnect()
	}, gi.initHtmlApi = function() {
		this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this), "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(gi.handleMutations), this.globalObserver.observe(document, {
			childList: !0,
			subtree: !0
		})), "complete" === document.readyState || "loading" !== document.readyState && !document.documentElement.doScroll ? window.setTimeout(this.initDOMLoadedElements) : (document.addEventListener("DOMContentLoaded", this.initDOMLoadedElements), window.addEventListener("load", this.initDOMLoadedElements))
	}, gi.handleMutations = function(t) {
		t.forEach((function(t) {
			Array.prototype.forEach.call(t.addedNodes, (function(t) {
				1 === t.nodeType && (t.hasAttribute("data-simplebar") ? !gi.instances.has(t) && new gi(t, qi(t.attributes)) : Array.prototype.forEach.call(t.querySelectorAll('[data-simplebar]:not([data-simplebar="init"])'), (function(t) {
					!gi.instances.has(t) && new gi(t, qi(t.attributes))
				})))
			})), Array.prototype.forEach.call(t.removedNodes, (function(t) {
				1 === t.nodeType && (t.hasAttribute('[data-simplebar="init"]') ? gi.instances.has(t) && gi.instances.get(t).unMount() : Array.prototype.forEach.call(t.querySelectorAll('[data-simplebar="init"]'), (function(t) {
					gi.instances.has(t) && gi.instances.get(t).unMount()
				})))
			}))
		}))
	}, gi.getOptions = qi, Yt && gi.initHtmlApi(), gi
}));